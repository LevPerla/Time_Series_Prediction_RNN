...
class Model():
    ...
    def __init__(self):
        ...
        params (dict): dict of params of model
        """
    ...
    def fit(self, x_train, y_train, epochs, batch_size=36, verbose=1, validation_data=None):
        '''
        Train model
        ...
        :param validation_data (tuple of len 2): (x_test, y_test)
        :return: None
        '''
        timer = Timer()
        timer.start()
